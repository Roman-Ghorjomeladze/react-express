...
let Job = (() => {
    ...
    var Job = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.paid = __runInitializers(this, _paid_initializers, void 0);
            this.paymentDate = __runInitializers(this, _paymentDate_initializers, void 0);
            this.Contract = __runInitializers(this, _Contract_initializers, void 0);
        }
    };
    ...
    (() => {
        ...
        _paid_decorators = [(0, sequelize_typescript_1.Column)({
        ...
        _Contract_decorators = [(0, sequelize_typescript_1.BelongsTo)(() => _1.Contract)];
        ...
        __esDecorate(null, null, _paid_decorators, { kind: "field", name: "paid", static: false, private: false, access: { has: obj => "paid" in obj, get: obj => obj.paid, set: (obj, value) => { obj.paid = value; } }, metadata: _metadata }, _paid_initializers, _instanceExtraInitializers);
        ...
        __esDecorate(null, null, _Contract_decorators, { kind: "field", name: "Contract", static: false, private: false, access: { has: obj => "Contract" in obj, get: obj => obj.Contract, set: (obj, value) => { obj.Contract = value; } }, metadata: _metadata }, _Contract_initializers, _instanceExtraInitializers);
